...
test_that("internal data correct", {
  expect_snapshot(meq_conversion)
})
...
test_that("meq() and charge_balance()", {
  ...
  expect_equal(cb$charge_balance[1:2], c(-1.4, -3.8))
  expect_equal(cb$anion_sum[1:2], c(6.25, 6.61))
  expect_equal(cb$cation_sum[1:2], c(6.08, 6.13))
})
